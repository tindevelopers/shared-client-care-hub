import type { AnalyticsExtension, AudienceSourceExtension, CampaignChannelExtension } from "../core/provider-extensions.js";
...
export interface CampaignsAdapter {
  ...
  listRecipients(id: string, query?: RecipientQuery): Promise<CrmUiResult<CampaignRecipientPage>>;
  previewAudience(source: CampaignAudience): Promise<CrmUiResult<AudiencePreviewVm>>;
  replaceAudience(id: string, source: CampaignAudience): Promise<CrmUiResult<{ replaced: number }>>;
}
