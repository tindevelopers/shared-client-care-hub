 ...
 * `select`, `eq`, `in`, `order`, `limit`, `single`, `maybeSingle`) in order,
 * so tests can assert the EXACT query shape the store produces against the
 * cataloged writer payloads (W4–W11, W17, W18).
 *
